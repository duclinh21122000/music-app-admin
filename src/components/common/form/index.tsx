...
export const Form = <T extends FieldValues>({
  ...
  const methods = (form || defaultMethods) as UseFormReturn<
    T,
    any,
    T | undefined
  >
...
const FormItem: React.FC<FormItemProps> = (props) => {
  ...
  const haveRef =
    JSON.stringify(err) === JSON.stringify(Object.values(errors).at(0))
      ? ref
      : null
  useEffect(() => {
  ...
  return (
    <>
      ...
      >
        {label && (
          <p className='min-w-fit gap-6 text-[14px] font-medium leading-tight text-black'>
